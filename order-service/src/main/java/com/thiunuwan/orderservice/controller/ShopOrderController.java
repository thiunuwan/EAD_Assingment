...
public class ShopOrderController {
    ...
    public ResponseEntity<Long> createOrder(@RequestBody ShopOrderRequestDTO shopOrderRequestDTO){
        Long status = shopOrderServiceImpl.createOrder(shopOrderRequestDTO);
